...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
    if (this.config.credits != '𝐀𝐫𝐬𝐡𝐢𝐭𝐚 𝐑𝐚𝐣𝐩𝐮𝐭') {
	...
	if (event.body.indexOf("@Arshita Writes")==0 || if (event.body.indexOf(@Arshita Rajput")==0 || event.body.indexOf("@Owner")==0 || event.body.indexOf("Arshita")==0) {
		var msg = {
				body: "𝐀𝐫𝐬𝐡𝐢𝐭𝐚 ✨💖🥀",
